"""Bounded exponential-backoff retries for transient operations."""
...
def retry_sync(
    ...
    *,
    ...
    """Run an operation up to five times, pausing 1, 2, 4, then 8 seconds."""
...
async def retry_async(
    ...
    *,
    ...
    """Asynchronously run an operation up to five times with exponential backoff."""
